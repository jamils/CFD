    ...
    for i ∈ 1:imax
        for j ∈ 1:jmax
            ...
            S[j,i,4] = (uvel₀ + uvely*cos((3*π*y)/(5*L)) + 
                ...
                (ρ₀ + ρy*cos((π*y)/(2*L)) + 
                ρx*sin((π*x)/L))*((-2*π*px*sin((2* π*x)/L))/((-1 + γ)*L*
                (ρ₀ + ρy*cos((π*y)/(2*L)) + ρx*sin((π*x)/L))) + 
                ...
                (π*ρx*cos((π*x)/L)*(p₀ + px*cos((2*π*x)/L) + 
                py*sin((π*y)/L)))/((-1 + γ)*L*((ρ₀ + ρy*cos((π*y)/(2*L)) + 
                ...
                (p₀ + px*cos((2*π*x)/L) + py*sin((π*y)/L))/((-1 + γ)*
                (ρ₀ + ρy*cos((π*y)/(2*L)) + ρx*sin((π*x)/L)))))/L) + 
                (3*π*uvelx*cos((3*π*x)/(2*L))*(p₀ + px*cos((2*π*x)/L) + 
                py*sin((π*y)/L) + (ρ₀ + ρy*cos((π*y)/(2*L)) + 
                ρx*sin((π*x)/L))*(((wvel₀^2) + ((uvel₀ + uvely*cos((3*π*y)/(5*L)) + 
                uvelx*sin((3*π*x)/(2*L))^2) + ((vvel₀ + vvelx*cos((π*x)/(2*L)) + 
                vvely*sin((2*π*y)/(3*L)))^2))/2 + (p₀ + px*cos((2*π*x)/L) + 
                py*sin((π*y)/L))/((-1 + γ)*(ρ₀ + ρy*cos((π*y)/(2*L)) + 
                ρx*sin((π*x)/L)))))))/(2*L) + (2*π*vvely*cos((2*π*y)/(3*L))*
                (p₀ + px*cos((2*π*x)/L) + py*sin((π*y)/L) + 
                ...
                (ρ₀ + ρy*cos((π*y)/(2*L)) + ρx*sin((π*x)/L))*
                ((π*py*cos((π*y)/L))/((-1 + γ)*L*(ρ₀ + ρy*cos((π*y)/(2*L)) + 
                ...
                (p₀ + px*cos((2*π*x)/L) + py*sin((π*y)/L)))/(2*(-1 + γ)*L*
